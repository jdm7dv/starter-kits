            ...
            while ( (line = sr.ReadLine()) != null ) {
                ...
                if (list.Length > 1) {
                    ...
                    if ((sourcelist.Length>0)) {
                        ...
                        fileName = Server.MapPath("~/" + ParseItem(sourcelist[0]).HRef);
                    }
                    ...
                    for (int i=0; i< sourcelist.Length; i++) {
                        ...
                        sb.Append(Path.GetFileName(item.Description));
                        sb.Append("</a>&nbsp;&nbsp; ");
                    }
                ...
                <tr valign="top">
                    <td>
                        ...
                        <table cellpadding=5 cellspacing=0 background="grid_background.gif"  width="100%">
                            <tr>
                                <td class="TitleBar">
                                    <span id="Title" class="SourceViewTitle" runat="server">IBuySpy Portal Source Code Viewer</span>
                                </td>
                            </tr>
                        </table>
