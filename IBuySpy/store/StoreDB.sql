...
exec sp_dboption N'Store', N'autoclose', N'false'
GO

exec sp_dboption N'Store', N'bulkcopy', N'true'
GO

exec sp_dboption N'Store', N'trunc. log', N'true'
GO

exec sp_dboption N'Store', N'torn page detection', N'false'
GO

exec sp_dboption N'Store', N'read only', N'false'
GO

exec sp_dboption N'Store', N'dbo use', N'false'
GO

exec sp_dboption N'Store', N'single', N'false'
GO

exec sp_dboption N'Store', N'autoshrink', N'true'
GO

exec sp_dboption N'Store', N'ANSI null default', N'false'
GO

exec sp_dboption N'Store', N'recursive triggers', N'false'
GO

exec sp_dboption N'Store', N'ANSI nulls', N'false'
GO

exec sp_dboption N'Store', N'concat null yields null', N'false'
GO

exec sp_dboption N'Store', N'cursor close on commit', N'false'
GO

exec sp_dboption N'Store', N'default to local cursor', N'false'
GO

exec sp_dboption N'Store', N'quoted identifier', N'false'
GO

exec sp_dboption N'Store', N'ANSI warnings', N'false'
GO

exec sp_dboption N'Store', N'auto create statistics', N'true'
GO

exec sp_dboption N'Store', N'auto update statistics', N'true'
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerAdd]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerAdd]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerAlsoBought]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerAlsoBought]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerDetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerDetail]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CustomerLogin]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[CustomerLogin]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OrdersAdd]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OrdersAdd]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OrdersCount]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OrdersCount]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OrdersDetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OrdersDetail]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OrdersList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OrdersList]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OrdersShipDate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OrdersShipDate]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ProductCategoryList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ProductCategoryList]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ProductDetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ProductDetail]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ProductsMostPopular]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ProductsMostPopular]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ReviewsAdd]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ReviewsAdd]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ReviewsDetail]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ReviewsDetail]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ReviewsList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ReviewsList]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartAddItem]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartAddItem]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartEmpty]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartEmpty]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartItemCount]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartItemCount]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartList]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartList]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartMigrate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartMigrate]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartRemoveAbandoned]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartRemoveAbandoned]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartRemoveItem]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartRemoveItem]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartTotal]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartTotal]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ShoppingCartUpdate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ShoppingCartUpdate]
GO
...
-- =======================================================
-- ADD SCHEDULED JOBS TO IBUYSPY Store DB
-- =======================================================
